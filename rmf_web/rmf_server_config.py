# NOTE: this file is an adaptation of the default config file found in the rmf-web api-server package: https://github.com/open-rmf/rmf-web/blob/e3d2b1c460af72eda810c90e20ddfd44d04d636f/packages/api-server/api_server/default_config.py
...
config = {
    ...
    "log_level": "DEBUG",  # https://docs.python.org/3.8/library/logging.html#levels
